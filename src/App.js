  ...
  return (
    <>
      ...
      <ul className="content__social">
        ...
        <li>
          <a href='https://twitter.com/SaatvaMattress/' target="_blank"><FontAwesomeIcon icon={["fab","twitter"]} className="icon_twitter" /></a>
        </li>
        <li>
          <a href='https://www.facebook.com/saatva/'target="_blank"><FontAwesomeIcon icon={["fab","facebook-f"]} className="icon_facebook" /></a>
        </li>
        <li>
      ...
      .then(
        (result) => {
          this.setState({
            ...
            currentArticle: result.data.articles[0]
          });
        },
        (error) => {
          this.setState({
